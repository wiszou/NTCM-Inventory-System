                        ...
                        <tbody id="inventoryTableBody">
                            ...
                            <tr class="">
                                ...
                                <td class="px-6 py-4 text-gray-900">
                                    <span class=" text-gray-50 rounded-xl px-2 py-1"></span>
                                    ...
                                    <div class="p-6 space-y-6">
                                        ...
                                        <div class="flex space-x-2 border-t border-gray-200 rounded-b">
                                            ...
                                            <div class=" w-full flex justify-end pt-4">
                                                ...
                                                <button
                                                    class="mr-2 text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-full text-sm px-5 py-2.5 text-center"
                                                    id="removeButton">Delete</button>
