                ...
                <tbody id="inventoryTableBody">
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <td class="px-6 py-4 items-center flex justify-center">
                            <button data-item-id="" onclick="openModal('{{ $item->category_id }}')" class="mr-1 btn btn-primary rounded-3xl text-ntccolor border border-ntccolor hover:bg-ntccolor hover:text-white font-medium text-sm p-1.5 text-center inline-flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 26 26" id="edit" width="23" fill="currentcolor">
                        ...
                        <div class="grid grid-cols-6 gap-6">
                            <div class="col-span-6 sm:col-span-3">
                                <label for="item-serial" class="block mb-2 text-sm font-medium text-gray-900">Category
                                    Name:</label>
                                <input type="text" name="name" id="nameCategory" class="shadow-sm  border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 editable-input" placeholder="Category Name" required="">
                            </div>

                            <div class="col-span-6 sm:col-span-2">
                                <label for="supplier-name" class="block mb-2 text-sm font-medium text-gray-900">Stock Requirement:</label>
                                <input type="number" name="stock" id="stock" class="shadow-sm  border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 editable-input" placeholder="10" required="">
                            </div>

                            <div class="col-span-6 sm:col-span-1">
                                <label for="item-model" class="block mb-2 text-sm font-medium text-gray-900">With Specs</label>
                                <input type="checkbox" name="specx" id="specx" value="1" class="w-16 mt-3">
                               
                            </div>
                            <div class="col-span-6 sm:col-span-1" hidden>
                            <input type="text" name="id" id="idxx" class="shadow-sm  border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 editable-input">
                            </div>
                        </div>
