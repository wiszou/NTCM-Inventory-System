                    ...
                    <div class="p-6 space-y-6">
                        ...
                        <div class="grid grid-cols-6 gap-6">
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <input type="text" name="inventory-id" id="inventory-id"
                                    ...
                                    placeholder="{{ $dataitem->item_id }}" disabled>
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <select data-te-select-init data-te-select-filter="true" name="item-brand" id="category"
                                    class="shadow-sm  bg-custom-color block w-full p-2.5 editable-input">
                                    @foreach ($brands as $brand)
                                    <option value="{{ $brand->brand_id }}"
                                        {{ $dataitem->brand_id == $brand->brand_id ? 'selected' : '' }}>
                                        {{ $brand->name }}
                                    </option>
                                    @endforeach
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                <label for="item-dateE" class="block mb-2 text-sm font-medium text-gray-900">Date
                                    Acquired</label>
                                <input type="date" value="{{ $specs->date_acquired}}" name="item-acquired"
                                    id="item-acquired"
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                <label for="item-dateE" class="block mb-2 text-sm font-medium text-gray-900">Date
                                    Expiration</label>
                                <input type="date" value="{{ $specs->date_end}}" name="item-expired" id="item-expired"
                                    class="shadow-sm  border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 editable-input"
                                    placeholder="4CE0460D0G" required="">
                            </div>
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <input type="text" name="item-model" id="item-model"
                                    class="shadow-sm  border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 editable-input"
                                    value="{{ $specs->model }}" placeholder="X250" required="">
                            </div>
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <input type="text" name="item-serial" id="item-serial"
                                    class="shadow-sm  border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 editable-input"
                                    value="{{ $specs->serial_num }}" placeholder="4CE0460D0G" required="">
                            </div>
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <input type="Number" name="item-price" id="item-price"
                                    class="shadow-sm  border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 editable-input"
                                    value="{{ $specs->price }}" placeholder="40,000" required="">
                            </div>
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <select data-te-select-init data-te-select-filter="true" name="item-category"
                                    ...
                                    <option data-specs="{{ $category->specs }}" value="{{ $category->category_id }}"
                                        {{ $dataitem->category_id == $category->category_id ? 'selected' : '' }}>
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <select data-te-select-init data-te-select-filter="true" name="supplier-name"
                                    ...
                                    <option value="{{ $supplier->supplier_id }}"
                                        {{ $dataitem->supplier_id == $supplier->supplier_id ? 'selected' : '' }}>
                                        {{ $supplier->name }}
                                    </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <select data-te-select-init data-te-select="true" name="supplier-name"
                                    id="supplier-name" class="shadow-sm w-full p-2.5  editable-input">
                                    <option value=""></option>
                            ...
                            <div class="col-span-6 sm:col-span-3" id="cpuInput" hidden>
                                ...
                                <input type="text" value="{{ $specs->cpu}}" name="item-cpu" id="item-serial-cpu"
                                    class="shadow-sm border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 editable-input"
                            ...
                            <div class="col-span-6 sm:col-span-3" id="gpuInput" hidden>
                                ...
                                <input type="text" value="{{ $specs->gpu}}" name="item-gpu" id="item-serial-gpu"
                                    class="shadow-sm border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 editable-input"
                            ...
                            <div class="col-span-6 sm:col-span-3" id="ramInput" hidden>
                                ...
                                <input type="text" value="{{ $specs->ram}}" name="item-ram" id="item-serial-ram"
                                    class="shadow-sm border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 editable-input"
                            ...
                            <div class="col-span-6 sm:col-span-3" id="storageInput" hidden>
                                ...
                                <input type="text" value="{{ $specs->storage}}" name="item-storage"
                                    id="item-serial-storage"
                                    class="shadow-sm border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 editable-input"
                        ...
                        <div class="flex space-x-2 border-t border-gray-200 rounded-b">
                            <div class=" w-full flex justify-end pt-4">
                                <button onclick="removeItemWithAjax('{{ $dataitem->item_id }}')"
                                    class="text-white bg-red-500 hover:bg-red-600 font-medium rounded-full px-5 h-10 mt-3 mb-3 text-sm text-center mr-2">Delete</button>
                                <button type="submit"
