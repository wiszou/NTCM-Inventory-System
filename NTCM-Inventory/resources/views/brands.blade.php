                ...
                <tbody id="suppliers">
                    ...
                    <tr>
                        ...
                        <td class="text-center items-center flex justify-center">
                            <label data-brand-id="{{ $item->brand_id }}" class="text-ntccolor border border-ntccolor hover:bg-ntccolor hover:text-white font-medium rounded-full text-sm p-1 mr-1 text-center inline-flex items-center cursor-pointer" onclick="openModal('{{ $item->brand_id }}')">
