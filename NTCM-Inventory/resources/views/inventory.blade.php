            ...
            <div class="w-full">
                ...
                <div class="p-8 my-2 lg:mt-0 rounded shadow bg-white flex flex-row justify-between">
                    ...
                    <button id="dropdownDefaultButton" data-dropdown-toggle="dropdown"
                        class="text-white bg-ntccolor hover:bg-teal-600 font-medium rounded-xl text-sm px-5 py-2.5 text-center inline-flex items-center"
                                    ...
                                    <div class="p-6 space-y-6">
                                        <div class="grid grid-cols-6 gap-6">
                                            ...
                                            <div class="col-span-6 sm:col-span-3">
                                                ...
                                                <select data-te-select-init data-te-select-filter="true"
                                                    ...
                                                    class="shadow-sm w-full p-2.5  editable-input" disabled>
                                            ...
                                            <div class="col-span-6 sm:col-span-3">
                                                ...
                                                <ul class="grid grid-cols-4 gap-x-5">
                                                    ...
                                                    <li class="">
                                                        ...
                                                        <label
                                                            class="text-xs flex justify-center cursor-pointer rounded-full border border-gray-300  py-2 px-4 hover:bg-white focus:outline-none peer-checked:border-transparent peer-checked:ring-2 peer-checked:ring-green-500 peer-checked:bg-green-50 transition-all duration-200 ease-in-out"
                                                            for="yes">Spare</label>
                                                    ...
                                                    <li class="">
                                                        ...
                                                        <label
                                                            class="text-xs flex justify-center cursor-pointer rounded-full border border-gray-300 py-2 px-4 hover:bg-white focus:outline-none peer-checked:border-transparent peer-checked:ring-2 peer-checked:ring-blue-500 peer-checked:bg-blue-50 transition-all duration-200 ease-in-out"
                                                    ...
                                                    <li class="">
                                                        ...
                                                        <label
                                                            class="text-xs flex justify-center cursor-pointer rounded-full border border-gray-300 py-2 px-4 hover:bg-white focus:outline-none peer-checked:border-transparent peer-checked:ring-2 peer-checked:ring-orange-500 peer-checked:bg-orange-50 transition-all duration-200 ease-in-out "
                                                    ...
                                                    <li class="">
                                                        ...
                                                        <label
                                                            class="text-xs flex justify-center cursor-pointer rounded-full border border-gray-300  py-2 px-4 hover:bg-white focus:outline-none peer-checked:border-transparent peer-checked:ring-2 peer-checked:ring-red-500 peer-checked:bg-red-50 transition-all duration-200 ease-in-out "
                                        ...
                                        <div class="flex space-x-2 border-t border-gray-200 rounded-b">
                                            <div class=" w-full flex justify-end pt-4">
                                                <a
                                                    class="mr-2 text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-full text-sm px-5 py-2.5 text-center">Delete</a>
                                                <a class="mr-2 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-full text-sm px-5 py-2.5 text-center"
                                                    id="editButton">Edit</a>
                                                <button type="submit"
                                                    class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-full text-sm px-5 py-2.5 text-center"
                                                    id="saveButton" disabled>Save</button>
                ...
                fetch(`/api/getItemDetails/${itemId}`)
                    ...
                    .then(data => {
                        if (data.success) {
                            ...
                            modal.querySelector('#title').textContent = data.item.brand + "-" + data.item
                                .model + "-" + data.item.serial_num;
