...
<body class="bg-gray-100 py-2">
                ...
                <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                    <div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
                        ...
                        <div class="w-full md:w-auto flex flex-col md:flex-row space-y-2 md:space-y-0 items-stretch md:items-center justify-end md:space-x-3 flex-shrink-0">
                            <button type="button" class="flex items-center justify-center text-gray-800 bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800 border">
                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                            ...
                            <tbody>
                                <!--ROW-->
                                <tr class="sub-container btn-success exploder border-b dark:border-gray-700 hover:bg-gray-50" onclick="toggleDetails(this)">
                                    <td class="w-4 p-4">
                                        <div class="flex items-center">
                                ...
                                <tr class="explode" style="display: none;">
                                    <td colspan="1">
    ...
    <script>
        ...
        function slideUp(element) {
            ...
            }, 300); // Ensure display is set to none after animation duration
        }
    </script>
</body>
