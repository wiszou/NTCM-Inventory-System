                                ...
                                <form action="#" class="relative bg-white">
                                    ...
                                    <div class="p-6 space-y-6">
                                        ...
                                        <div class="flex space-x-2 border-t border-gray-200 rounded-b">
                                            ...
                                            <button type="submit"
                                                    class="mr-2 text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-full text-sm px-5 py-2.5 text-center">Delete</button>
                                                <button type="submit"
                                                    class="mr-2 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-full text-sm px-5 py-2.5 text-center">Edit</button>
                                                <button type="submit"
