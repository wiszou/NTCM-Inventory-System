                                    ...
                                    <div class="p-6 space-y-6">
                                        ...
                                        <div id="container12">
                                            <select name="item1" id="item1" class="js-example-basic-single" required="">
                                                ...
                                                @if ($item->deleted == "false" && $item->item_status == "Spare" || $item->item_status == "Stock")
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        response.forEach(function(element) {
                            ...
                            var container = $('<div class="grid grid-cols-6 flex-row items-center"></div>');
                            // Create the first input field
                            var inputField = $(
                                '<div class="col-span-6 sm:col-span-3 pr-2" hidden>' +
                                '<input type="text"" name="itemDetail' + index + '" value ="' + element.item_id + '" id="itemDetail' + index + '" class="shadow-sm border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-1.5">' +
                                '</div>'
                            );

                            var textfieldField = $(
                                '<div class="col-span-6 sm:col-span-3 pr-2">' +
                                '<p class="shadow-sm border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-1.5">' + element.item_id + " - " + element.name + '</p>' +
                                '</div>'
                            );
                            ...
                            if (element.custodian_id == element.current_custodianID && element.item_status == element.item_currentStatus) {
                                selectField = $('<div class="col-span-6 sm:col-span-3 pr-2 space-y-2">' +
                                    ...
                                    'onclick="toUpdate(\'' + element.item_id + '\', \'Spare\')" id="/update-item">Returned</button>' +
                                    ...
                                    'onclick="toUpdate(\'' + element.item_id + '\', \'Missing\')" id="/update-item">Missing</button>' +
                                    ...
                                    'onclick="toUpdate(\'' + element.item_id + '\', \'Defective\')" id="/update-item">Defect</button>' +
                                    '</div>'
                                );
                        ...
                        if (sampleArray.includes(currentStatus)) {
                            ...
                            $('#buttonReturn')
                                .attr('type', 'button')
                                .addClass('mr-2 w-24 text-white bg-gray-300 rounded-full text-sm py-1.5 text-center')
                                .css('color', 'grey')
                                .prop('disabled', true)
