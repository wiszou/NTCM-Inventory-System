...
<body class="bg-gray-100 py-2">
    ...
    <div class="ml-auto px-2 lg:w-[75%] xl:w-[80%] 2xl:w-[85%] h-full">
        <div class="my-auto flex justify-start">
                        ...
                        <tbody id="inventoryTableBody">
                            ...
                            <tr item-id="{{ $item->custodian_id }}">
                                ...
                                <td class="text-center items-center flex justify-center">
                                    <button id="open-modal2-button" onclick="toReturn('{{ $item->custodian_id}}')"
                                    ...
                                    <label onclick="toPrint('{{ $item->custodian_id}}')"
            ...
            <div class="main2-modal fixed w-full h-150px inset-0 z-50 flex justify-center items-center animated fadeIn faster"
                style="background: rgba(0,0,0,.7);">
                <div class="modal-container bg-white w-1/2 h-4/6  relative rounded-xl z-50">
                    <div class="modal-content py-4 text-left px-6 ">
                        <!--Title-->
                                    ...
                                    <div class="p-6 space-y-6">
                                        <div class="grid grid-cols-6 gap-6">
                                            ...
                                            <div class="col-span-6 sm:col-span-4">
                                                <label for="custodian-name"
                                                    class="block mb-2 text-sm font-medium text-gray-900">Items:</label>
                                            </div>
                                        ...
                                        <div class="grid grid-cols-6 flex-row items-center">
                                            <div class="col-span-6 sm:col-span-4 pr-2">
                                            ...
                                            <div class="col-span-6 sm:col-span-2 pl-2">
                                                <select data-te-select-init data-te-select="true" name="item-status"
                                                    id="supplier-name" class="shadow-sm w-full p-2.5  editable-input">
                                                    <option value="Stock">Returned
                                                    </option>
                        ...
                        <div class="w-full justify-end flex space-x-2 border-gray-200 rounded-b">
                            <button type="submit"
                                class=" mr-2 w-32 text-white bg-ntccolor  hover:bg-teal-600  focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-full text-sm px-5 py-2.5 text-center"
                                id="/update-item">Return All</button>
                        </div>
                    </div>
                </div>
            </div>
        ...
        // Get the button element by its ID for the second modal
        const openModal2Button = document.getElementById('open-modal2-button');
        if (openModal2Button) {
