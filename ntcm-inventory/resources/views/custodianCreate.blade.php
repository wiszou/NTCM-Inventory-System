                        ...
                        <tbody id="inventoryTableBody">
                            ...
                            <tr item-id="{{ $item->custodian_id }}">
                                ...
                                <td class="text-center items-center flex justify-center">
                                    <button onclick="openModal2('{{ $item->custodian_id}}')"
                                ...
                                <form id="create-form" method="post" class="relative bg-white">
                                    ...
                                    <div class="p-6 space-y-6">
                                        ...
                                        <div class="flex justify-end items-center">
                                            <a class="w-6 mr-1" href="#" id="appendButton">
                                                <svg viewBox="0 0 23 23" fill="none" xmlns="http://www.w3.org/2000/svg"
                                                    stroke="#e31616" width="25px">
                                                    <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                                    <g id="SVGRepo_tracerCarrier" stroke-linecap="round"
                                                        stroke-linejoin="round"></g>
                                                    <g id="SVGRepo_iconCarrier">
            ...
            <div class="main2-modal fixed w-full h-150px inset-0 z-50 flex justify-center items-center animated fadeIn faster"
                ...
                <div class="modal-container bg-white w-1/2 h-4/6  relative rounded-xl z-50">
                    <div class="modal-content py-4 text-left px-6 ">
                                ...
                                <form id="create-form" method="post" class="relative bg-white">
                                    ...
                                    <div class="p-6 space-y-6">
                                        <div class="grid grid-cols-6">
                                            ...
                                            <div class="col-span-6 sm:col-span-3">
                                                <label for="custodian-name"
                                                    class="block text-sm font-medium text-gray-900">Items:</label>
                                            </div>
                        ...
                        <div class="w-full justify-end flex space-x-2 border-gray-200 rounded-b">
                            <button type="button" id="buttonReturn"
                                class=" mr-2 w-32 text-white bg-ntccolor hover:bg-teal-600  focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-full text-sm px-5 py-2.5 text-center">Close</button>
                        </div>
                    </div>
                </div>
            </div>
